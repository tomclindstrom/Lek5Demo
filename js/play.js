...
*/
		...
		*/
		...
		this.enemies.createMultiple(30, 'gameElements', 'enemy-01')*40;
...
/*
	movePlayer: function() {
		// || this.moveLef
		if (this.cursor.left.isDown || this.altKeys.left.isDown || this.wasd.left.isDown) {
	...
	*/
	 movePlayer: function() {
      if(this.cursor.left.isDown || this.altKeys.left.isDown || this.moveLeft) {
        ...
        this.player.body.velocity.x = 0;
        this.player.animations.stop();
        this.player.frameName = 0;
      }

      if ((this.cursor.up.isDown || this.altKeys.up.isDown && this.player.body.onFloor())) {
        this.jumpPlayer();
      }
    },
	...
	*/
	...
	addMobileInputs: function(){
      ...
      this.rightButton = this.game.add.sprite(150, 247, 'rightButton');
      this.rightButton.inputEnabled = true;
